...
import com.petbox.suscripciones.dto.ErrorDTO;
...
public class ManejadorErrores {
    ...
    public ResponseEntity<ErrorDTO> miManejador(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        ErrorDTO errorDto = new ErrorDTO(
            ...
            "Error de validación en los parámetros de la suscripción.",
            mapaErrores,
    ...
    public ResponseEntity<ErrorDTO> miManejadorBD(DataIntegrityViolationException ex, HttpServletRequest request) {
        Map<String, String> mapaErrores = new HashMap<>();
        mapaErrores.put("db", "Este usuario ya cuenta con una suscripción activa.");

        ErrorDTO errorDto = new ErrorDTO(
            LocalDateTime.now(),
            HttpStatus.CONFLICT.value(),
            "Error de duplicidad de suscripciones en Laragon.",
            mapaErrores,
            request.getRequestURI()
        );
